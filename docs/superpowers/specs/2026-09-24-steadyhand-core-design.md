...
- `holidays.toml`: IDX non-trading days by year. `calendar.py` refuses to run for a year that has no holiday data, instead of assuming no holidays. Years verified from IDX announcements so far: 2025 (`docs/research/t-pay.md` §2) and 2026–2027 (`docs/research/t-rules.md` §4).
