...
| T-FEES | **Open (#38):** the exchange levy and its components, the regulation for the 0.1% sale tax, and published broker fee schedules | `fees.toml` and M2's fees task |
